package com.includecar.includecar.fragments.rescuemap;
 ...
 * {@link RescueMapFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RescueMapFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RescueMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public static RescueMapFragment newInstance(String param1, String param2) {
        RescueMapFragment fragment = new RescueMapFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rescue_map, container, false);
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.map_rescue_fragment_map);
        if(mapFragment != null){
    ...
    public void onMapReady(GoogleMap googleMap) {
        String latitude = Paper.book().read("rescue_my_position_latitude");
        String longitude = Paper.book().read("rescue_my_position_longitude");
        ...
        if(googleMap != null){
            ...
            if( latitude != null && !latitude.trim().equals("") && longitude != null && !longitude.trim().equals("")){
                if(car_lat == null || car_lat.trim().equals("") || car_lng == null || car_lng.trim().equals("")){
                    ...
                    LatLng resPos = new LatLng(Double.parseDouble(latitude),
                            Double.parseDouble(longitude));
