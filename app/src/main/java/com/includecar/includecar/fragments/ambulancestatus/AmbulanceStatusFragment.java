package com.includecar.includecar.fragments.ambulancestatus;
 ...
 * {@link AmbulanceStatusFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AmbulanceStatusFragment#newInstance} factory method to
...
public class AmbulanceStatusFragment extends Fragment implements ActivityCompat.OnRequestPermissionsResultCallback, LocationListener{
    ...
    public AmbulanceStatusFragment() {
    ...
    public static AmbulanceStatusFragment newInstance(String param1, String param2) {

        AmbulanceStatusFragment fragment = new AmbulanceStatusFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ambulance_status, container, false);
                        ...
                        if(locMan != null){
                            try{
                                locMan.requestLocationUpdates(
                                        LocationManager.GPS_PROVIDER, 1000, 1, AmbulanceStatusFragment.this );
